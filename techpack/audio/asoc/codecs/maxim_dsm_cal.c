...
static DEVICE_ATTR(amp_screen_ratio, 0444, maxdsm_cal_amp_screen_validation_show, NULL);
...
static DEVICE_ATTR(amp_screen_ratio_r, 0444, maxdsm_cal_amp_screen_validation_r_show, NULL);
