 ...
 *
*/
#include "ss_dsi_smart_dimming_S6E3FA5_AMS420QW01.h"
...
{
	return VREG0_REF_6P7;
}

static int get_base_luminance(struct SMART_DIM *pSmart)
{
	int cnt;
	int (*base_luminance)[2];

	base_luminance = base_luminance_revA;
...
struct smartdim_conf *smart_get_conf_S6E3FA5_AMS420QW01(void) {
