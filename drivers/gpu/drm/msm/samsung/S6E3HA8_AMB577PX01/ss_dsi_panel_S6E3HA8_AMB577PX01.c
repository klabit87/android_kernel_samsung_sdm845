...
*/
#include "ss_dsi_panel_S6E3HA8_AMB577PX01.h"
#include "ss_dsi_mdnie_S6E3HA8_AMB577PX01.h"
#include "ss_dsi_mdnie_S6E3HA8_AMB577PX01.h"
...
static struct dsi_panel_cmd_set *ss_hbm_etc(struct samsung_display_driver_data *vdd, int *level_key)
{
	...
	u8 hbm_elvss_3th_val_array_revH[] = {
...
static void samsung_panel_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->panel_func.samsung_smart_get_conf = smart_get_conf_S6E3HA8_AMB577PX01;
	...
	vdd->panel_func.samsung_smart_get_conf_hmt = smart_get_conf_S6E3HA8_AMB577PX01_hmt;
...
static int __init samsung_panel_initialize(void)
{
	...
	char panel_string[] = "ss_dsi_panel_S6E3HA8_AMB577PX01_WQHD";
