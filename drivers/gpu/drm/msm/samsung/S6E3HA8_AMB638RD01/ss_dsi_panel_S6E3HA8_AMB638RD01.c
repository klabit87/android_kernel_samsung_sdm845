...
*/
#include "ss_dsi_panel_S6E3HA8_AMB638RD01.h"
#include "ss_dsi_mdnie_S6E3HA8_AMB638RD01.h"
...
static struct dsi_panel_cmd_set *ss_hbm_etc(struct samsung_display_driver_data *vdd, int *level_key)
{
	...
	*/
	...
	hbm_etc_cmds->cmds[1].msg.tx_buf[23] = 	vdd->display_status_dsi.elvss_value2;
...
static char coordinate_data_1[][COORDINATE_DATA_SIZE] = {
	...
	{0xf9, 0x00, 0xfe, 0x00, 0xff, 0x00}, /* Tune_9 */
};

static char coordinate_data_2[][COORDINATE_DATA_SIZE] = {
	{0xff, 0x00, 0xff, 0x00, 0xff, 0x00}, /* dummy */
	{0xff, 0x00, 0xf4, 0x00, 0xeb, 0x00}, /* Tune_1 */
	{0xff, 0x00, 0xf5, 0x00, 0xef, 0x00}, /* Tune_2 */
	{0xff, 0x00, 0xf7, 0x00, 0xf5, 0x00}, /* Tune_3 */
	{0xff, 0x00, 0xf6, 0x00, 0xea, 0x00}, /* Tune_4 */
	{0xff, 0x00, 0xf8, 0x00, 0xef, 0x00}, /* Tune_5 */
	{0xff, 0x00, 0xfa, 0x00, 0xf6, 0x00}, /* Tune_6 */
	{0xff, 0x00, 0xf9, 0x00, 0xeb, 0x00}, /* Tune_7 */
...
static int coefficient[][COEFFICIENT_DATA_SIZE] = {
	...
	{  103768,  85145, -27718, -32352, -28331,  16524,   1732,   1596 },
	{  -81285, -63979,  20410,  25685, -28619,  16514,   1701,   1714 },
	{  -83877, -67077,  21368,  26555,  28835, -16256,  -1781,  -1787 },
	{   72505,  56763, -17892, -23103, -22596, -64077,  14499,  13681 },
};
...
static struct dsi_panel_cmd_set *ss_acl_on(struct samsung_display_driver_data *vdd, int *level_key)
{
	...
	*/
	if (vdd->lux >= vdd->enter_hbm_lux)
		pcmds->cmds[0].msg.tx_buf[2] = 0x44;
	else if (vdd->mdnie_tune_state_dsi->mdnie_app == GALLERY_APP)
		pcmds->cmds[0].msg.tx_buf[2] = 0x44;
	else
		pcmds->cmds[0].msg.tx_buf[2] = 0x55;
...
static struct dsi_panel_cmd_set *ss_elvss(struct samsung_display_driver_data *vdd, int *level_key)
{
	...
	*/
	...
	elvss_cmds->cmds->msg.tx_buf[23] = elvss_23th_val;
...
static void samsung_panel_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->panel_func.samsung_smart_get_conf = smart_get_conf_S6E3HA8_AMB638RD01;
...
static int __init samsung_panel_initialize(void)
{
	...
	char panel_string[] = "ss_dsi_panel_S6E3HA8_AMB638RD01_WQHD";
