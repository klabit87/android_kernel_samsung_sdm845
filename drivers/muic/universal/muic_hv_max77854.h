...
extern muic_attached_dev_t max77854_afc_muic_check_id_err
...
extern void max77854_afc_init_detect(struct hv_data *phv);
...
extern void max77854_afc_initialize(muic_data_t *pmuic, struct hv_data **pphv);
extern void max77854_afc_configure_AFC(struct hv_data *phv);
extern bool max77854_afc_do_predetach(struct hv_data *phv, int mdev);
extern void max77854_afc_do_detach(struct hv_data *phv);
extern void hv_irq_init(struct hv_data *phv);
extern void hv_muic_change_afc_voltage(muic_data_t *pmuic, int tx_data);
extern void max77854_afc_clear_hvcontrol(struct hv_data *phv);
extern int muic_max77854_afc_set_voltage(int vol);
extern int muic_max77854_set_afc(bool enable);
