...
JOPP_CC		?= $(srctree)/prebuilts/gcc-cfp/gcc-cfp-jopp-only/aarch64-linux-android-4.9/bin/aarch64-linux-android-gcc
CC		= $(srctree)/scripts/gcc-wrapper.py $(JOPP_CC)
endif
ifdef CONFIG_RKP_CFP_ROPP
ROPP_CC		?= $(srctree)/prebuilts/gcc-cfp/gcc-cfp-single/aarch64-linux-android-4.9/bin/aarch64-linux-android-gcc
