...
static inline int sec_debug_save_panic_info(
			const char *str, unsigned long caller) { return 0; }
static inline void sec_debug_secure_app_addr_size(uint32_t addr,
			uint32_t size) { }
